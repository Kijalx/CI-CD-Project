...
class CreateWorkerTest {
    ...
    @Test
    void getNameFail() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, ()-> new CreateWorker("A","GB12ABCD10203012345678", "AAAABBCCDDD", 10.50));
        assertEquals("This is not a valid name must be 3 or more characters", exMessage.getMessage());
    }

    @Test
    void getIbanFail() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, ()-> new CreateWorker("Aleks","GB12ABCD1020301234567", "AAAABBCCDDD", 10.50));
        assertEquals("This is not a valid iban", exMessage.getMessage());
    }

    @Test
    void getBicFail() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, ()-> new CreateWorker("Aleks","GB12ABCD10203012345678", "AAAABBC", 10.50));
        assertEquals("This is not a valid bic", exMessage.getMessage());
    }

    @Test
    void getRateFail() {
        Exception exMessage = assertThrows(IllegalArgumentException.class, ()-> new CreateWorker("Aleks","GB12ABCD10203012345678", "AAAABBCCDDD", 10));
